...
"  <select id ="+"hqCost1 "+"name="+"hq.hqCost1"+" hidden></select>"+
...
/*2*/"<select id ="+"troops2 "+"name="+"troops.troop2"+"></select>"+
"  <select id ="+"tCost2 "+"name="+"troops.tCost2"+" hidden></select>"+
/*3*/"<select id ="+"troops3 "+"name="+"troops.troop3"+"></select>"+
"  <select id ="+"tCost3 "+"name="+"troops.tCost3"+" hidden></select>"+
/*4*/"<select id ="+"troops4 "+"name="+"troops.troop4"+"></select>"+
"  <select id ="+"tCost4 "+"name="+"troops.tCost4"+" hidden></select>"+
...
/*2*/"<select id ="+"elites2 "+"name="+"e.elite2"+"></select>"+
"  <select id ="+"eCost2 "+"name="+"e.eCost2"+" hidden></select>"+
/*3*/"<select id ="+"elites3 "+"name="+"e.elite3"+"></select>"+
"  <select id ="+"eCost3 "+"name="+"e.eCost3"+" hidden></select>"+
/*4*/"<select id ="+"elites4 "+"name="+"e.elite4"+"></select>"+
"  <select id ="+"eCost4 "+"name="+"e.eCost4"+" hidden></select>"+
...
/*2*/"<select id ="+"lordofwar2 "+"name="+"low.low2"+"></select>"+
"  <select id ="+"lowCost2 "+"name="+"low.lowCost2"+" hidden></select>"+
/*3*/"<select id ="+"lordofwar3 "+"name="+"low.low3"+"></select>"+
"  <select id ="+"lowCost3 "+"name="+"low.lowCost3"+" hidden></select>"+
...
/*3*/"<select id ="+"transport3 "+"name="+"dt.dt3"+"></select>"+
"  <select id ="+"dtCost3 "+"name="+"dt.tdCost3"+" hidden></select>"+
/*4*/"<select id ="+"transport4 "+"name="+"dt.dt4"+"></select>"+
"  <select id ="+"dtCost4 "+"name="+"dt.tdCost4"+" hidden></select>"+
